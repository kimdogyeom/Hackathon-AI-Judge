...
class SocialImpactChain(EvaluationChainBase):
    ...
    def _load_evaluation_criteria(self, config_path: str):
        ...
        ## 분류별 평가 기준:
        - **PainKiller 관점**: 구체적인 사회 문제 해결과 그 효과성에 중점
        - **Vitamin 관점**: 사회적 가치 창출과 삶의 질 향상에 중점
        - **Balanced 관점**: 문제 해결과 가치 창출의 균형적 사회적 기여

        ## 평가 수행:
        {classification} 특성을 고려하여 이 프로젝트의 사회적 영향도를 0-10점 척도로 평가해주세요.
